...
import ridvan.staj.MovieCollectionInternProject.util.MovieFormWrapper;
import ridvan.staj.MovieCollectionInternProject.util.TextForm;
...
public class AppController {
	...
	public String confirmCreation(@ModelAttribute MovieFormWrapper mfw, Model model) {
		...
		movie.setLanguage(mfw.getLanguage());
		movie.setMedia(mfw.getMedia());;
